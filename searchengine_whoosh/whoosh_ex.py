...
def indexing():  # 단어 인덱싱 함수
    global ix
    indexdir = r'C:\Users\Huawei MateBook D14\Desktop\S4\Big data\Patented-search-site-with-n-gram-search-engine-using-Kipris-data\Whoosh_django\django1\searchengine_whoosh'
    ...
    writer = ix.writer()
    f = open(r'C:\Users\Huawei MateBook D14\Desktop\S4\Big data\Patented-search-site-with-n-gram-search-engine-using-Kipris-data\Whoosh_django\django1\searchengine_whoosh\인천대학교(인천).csv', encoding="UTF-8")
